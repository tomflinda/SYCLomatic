...
// CHECK-NEXT:  /*
// CHECK-NEXT:  DPCT1026:{{[0-9]+}}: The call to "cp.async.commit_group;" was removed because synchronous copy operation is used. You may need to adjust the code to tune the performance.
// CHECK-NEXT:  */
// CHECK-EMPTY:
// CHECK-NEXT:}
...
// CHECK-NEXT:  /*
// CHECK-NEXT:  DPCT1026:{{[0-9]+}}: The call to "cp.async.wait_group 0;" was removed because synchronous copy operation is used. You may need to adjust the code to tune the performance.
// CHECK-NEXT:  */
// CHECK-EMPTY:
// CHECK-NEXT:}
...
// CHECK-NEXT:  /*
// CHECK-NEXT:  DPCT1026:{{[0-9]+}}: The call to "cp.async.wait_all;" was removed because synchronous copy operation is used. You may need to adjust the code to tune the performance.
// CHECK-NEXT:  */
// CHECK-EMPTY:
// CHECK-NEXT:}
