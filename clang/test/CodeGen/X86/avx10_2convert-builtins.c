...
__m128i test_mm_cvtneph_pbf8(__m128h __A) {
  ...
  // CHECK: call <16 x i8> @llvm.x86.avx10.mask.vcvtph2bf8512128(
...
__m128i test_mm256_cvtneph_pbf8(__m256h __A) {
  ...
  // CHECK: call <16 x i8> @llvm.x86.avx10.mask.vcvtph2bf8512256(
...
__m128i test_mm_cvtnesph_pbf8(__m128h __A) {
  ...
  // CHECK: call <16 x i8> @llvm.x86.avx10.mask.vcvtph2bf8512s128(
...
__m128i test_mm256_cvtnesph_pbf8(__m256h __A) {
  ...
  // CHECK: call <16 x i8> @llvm.x86.avx10.mask.vcvtph2bf8512s256(
